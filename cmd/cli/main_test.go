...
`
	...
	if events[0].Type != models.EventWorkflowStarted {
		t.Fatalf("events[0].Type = %q, want %q", events[0].Type, models.EventWorkflowStarted)
	}
	if events[1].Type != models.EventStepStarted {
		t.Fatalf("events[1].Type = %q, want %q", events[1].Type, models.EventStepStarted)
	}
	if events[2].Type != models.EventStepFinished {
		t.Fatalf("events[2].Type = %q, want %q", events[2].Type, models.EventStepFinished)
	}
	if events[3].Type != models.EventWorkflowFinished {
		t.Fatalf("events[3].Type = %q, want %q", events[3].Type, models.EventWorkflowFinished)
	}
...
func decodeEvents(t *testing.T, output string) []models.RunEvent {
	t.Helper()
